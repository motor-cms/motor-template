        ...
        'default' => [
            ...
            'paths' => [
                ...
                */
                'annotations' => [
                    base_path('app'),
                    base_path('packages/motor-admin/src'),
                    base_path('packages/motor-core/src'),
                    base_path('packages/motor-cms/src'),
                    base_path('packages/motor-media/src'),
                ],
            ],
        ],
    ],
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            'processors' => [
                ...
                new OpenApi\Processors\AugmentParameters(false),
